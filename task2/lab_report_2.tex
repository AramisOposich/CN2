...
\begin{figure}[!ht]
	\centering % centering figure 
	\includegraphics[width=\textwidth]{images/comparison.pdf} % importing figure
...
\begin{figure}[!ht]
	...
	\label{fig:Audio} % labeling to refer it inside the text
\end{figure}
...
\begin{figure}[!ht]
	...
	\label{fig:Video} % labeling to refer it inside the text
\end{figure} 
