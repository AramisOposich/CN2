...
****** Muss noch an die richtige Stelle kopiert werden
...
One result of this is that the packet loss of the out going traffic is always zero independent on the chosen connection or codec.
